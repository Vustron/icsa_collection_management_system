...
<body class="min-h-screen bg-gray-50">
                    ...
                    <div class="relative">
                        ...
                        <div id="profileDropdown"
                            ...
                            <a href="{{route('my_account.index')}}"
                                ...
                                <x-bx-user class="mr-3 h-5 w-5  {{request()->routeIs('my_account.*') ?  'text-white' : 'text-purple-600'}}" />
                                My Account
                            </a>
                            <a href="{{route('admin_manager.index')}}"
                                ...
                                <x-bx-shield class="mr-3 h-5 w-5{{request()->routeIs('my_account.*') ?  'text-white' : 'text-purple-600'}}" />
                                Admin Manager
                            </a>
    ...
    <!-- Main Content -->
    <main id="mainContent" class="main transition-all duration-100 lg:ml-64  mt-[64px] p-2">
        {{ $slot }}
        <!-- Footer -->
