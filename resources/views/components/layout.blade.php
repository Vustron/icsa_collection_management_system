...
<html lang="en">
    ...
    <body class="bg-[rgb(234, 235, 239)] min-h-screen">
            ...
            <div class="flex h-14 items-center px-4">
                ...
                <div class="flex w-full items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Notifications -->
                        <div class="relative">
                            <button class="relative rounded-full bg-gray-100 p-1 hover:bg-gray-200 focus:outline-none">
                        ...
                        <div class="relative">
                            <div class="flex items-center space-x-3">
                                ...
                                <button id="profileDropdownButton"
                                    class="relative rounded-full bg-gray-100 p-1 hover:bg-gray-200 focus:outline-none">
                                ...
                                <div
                                    class="pointer-events-none absolute bottom-0 right-0 rounded-full border-2 border-white bg-gray-100">
                                    <svg class="text-black-600 hover:text-black-800 h-3 w-3 rotate-[-90deg]"
        ...
        <main id="mainContent" class="main mt-[56px] p-2 transition-all duration-100 lg:ml-64">
            <div class="w-full rounded-bl-lg rounded-br-lg border-t-[3px] border-t-violet-600 bg-white p-3 shadow-lg">
                {{ $slot }}
                <!-- Footer -->
