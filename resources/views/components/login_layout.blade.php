...
<body class="min-h-screen bg-purple-50 bg-[url('/public/images/bg.png')] bg-cover bg-center">
    <div class="grid min-h-screen w-full grid-cols-1 lg:grid-cols-2">
        ...
        <div
            class="lg:bg-[#ededed] flex flex-col items-center justify-center bg-[url('/public/images/bg.png')] bg-cover bg-center p-4 lg:bg-[url('')]">
            ...
            <span class="pt-3 text-center text-sm lg:text-gray-500 text-white">© Ambot Unsay I butang deri 2025</span>
        </div>
    </div>
