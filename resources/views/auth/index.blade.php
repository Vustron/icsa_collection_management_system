    ...
    <body class="min-h-screen bg-gray-50">
        <div class="grid min-h-screen w-full grid-cols-1 lg:grid-cols-2">
            ...
            <div class="relative hidden lg:block">
                ...
                <div class="absolute inset-0 bg-[url('/public/images/bg.png')] bg-cover bg-center mix-blend-overlay"></div>
                <div class="relative z-10 flex h-full flex-col items-center justify-center p-12 text-white">
                    <img src="{{ asset('images/icsa_logo.png') }}" alt="ICSA Logo" class="mb-8 h-24 w-24 animate-float">
                    ...
                    <p class="max-w-md text-center text-lg text-gray-100">
                        Welcome to the ICSA Collection Management System. Streamline student payments and manage finances efficiently.
                    </p>
                    <div class="mt-12 flex space-x-4">
                        <a href="#" class="rounded-full bg-white bg-opacity-20 px-6 py-2 font-medium text-white backdrop-blur-sm transition hover:bg-opacity-30">Learn More</a>
                        <a href="{{ route('login') }}" class="rounded-full bg-white px-6 py-2 font-medium text-purple-600 transition hover:bg-gray-100">Sign In</a>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full max-w-md">
                    ...
                    <form action="{{ route('signup.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="user_name" id="user_name"
                                    ...
                                    placeholder="Choose a username" required maxlength="255" value="{{ old('user_name') }}" />
                            </div>
                            @error('user_name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email"
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 py-3 pl-10 pr-3 text-gray-900 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
                                    placeholder="Your email address" required maxlength="255" value="{{ old('email') }}" />
                            </div>
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <svg id="buttonLoader" class="ml-2 h-5 w-5 animate-spin hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
