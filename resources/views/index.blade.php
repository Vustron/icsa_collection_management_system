...
<x-login_layout>
    @if ($errors->has('not_authorized'))
        <div class="error-badge mb-4 flex items-center justify-center rounded-md border border-red-200 bg-red-50 p-3 shadow-sm">
    ...
    @endif
     ...
     <x-ui.card.body class="login-card border border-purple-100 shadow-lg w-auto">
                   ...
                   <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <x-ui.form.input
                                ...
                                autocomplete="email"
                                class="form-input border-gray-300 pl-10 focus:border-purple-400 focus:ring focus:ring-purple-200 focus:ring-opacity-50 {{ $errors->has('email') ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : '' }}"
                            />
                        </div>
                        @if ($errors->has('email'))
                            <div class="error-badge mt-1 flex items-center space-x-1 rounded-md bg-red-50 px-2 py-1">
                                ...
                                <span class="text-xs font-small text-red-800">{{ $errors->first('email') }}</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <x-ui.form.input
                                ...
                                class="form-input border-gray-300 pl-10 pr-10 focus:border-purple-400 focus:ring focus:ring-purple-200 focus:ring-opacity-50 {{ $errors->has('password') ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : '' }}"
                            />
                            <button
                                type="button"
                                id="togglePassword"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        {{-- Forgot Password --}}
                        <a href="{{ route('forgot_password') }}" class="text-sm font-medium text-purple-600 hover:text-purple-800">
                            Forgot password?
                        </a>
                    </div>
                    ...
                    >
                        ...
                        <svg class="buttonLoader ml-2 hidden h-5 w-5 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
