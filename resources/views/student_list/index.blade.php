...
<x-layout>
    <div class="container mx-auto p-4">
        <div class="bg-white shadow rounded-lg p-6">
            <h1 class="text-3xl font-bold text-purple-700 mb-5 mt-1">Student List</h1>

            <div class="flex justify-between items-center mb-4">
                <div>
                    <label for="show-entries" class="text-sm font-medium text-gray-700">Show</label>
                    <select id="show-entries"
                        class="border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500 text-sm border-2">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button onclick="showDialog('filterDialog')"
                        class="flex bg-gray-200 text-black px-3 py-2 rounded-md text-sm hover:bg-gray-300">
                        <img src="/storage/icons/filter.png" alt="filter" class="w-5 h-5">
                        ...
                        <div class="bg-white p-6 rounded-lg w-96">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="filterProgram"
                                    class="w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
                            ...
                            {{-- filter by set --}}
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Filter by Set</label>
                                <select id="filterSet"
                                    class="w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
                            ...
                            <div class="flex justify-end space-x-2">
                                <button id="resetFilters"
                                    class="bg-gray-200 text-black px-4 py-2 rounded-md text-sm hover:bg-gray-300">
                                    Reset Filters
                                </button>
                                <button id="applyFilters"
                                    class="bg-purple-500 text-white px-4 py-2 rounded-md text-sm hover:bg-purple-600">
                                    Apply Filters
                                </button>
                            </div>
                        </div>
                    ...
                    <div>
                        <input type="text" id="search"
                            class="border-2 border-gray-300 rounded-md text-sm px-4 py-2" placeholder="Search...">
                    </div>
                            ...
                            <form id="addCollectionForm">
                                <div class="mb-4">
                                    ...
                                    <span class="flex">
                                        <input type="text" id="dialogstudentId"
                                            class="mt-1 block w-full border-2 border-gray-300 rounded-md text-sm px-4 py-2"
                                ...
                                <div class="mb-4 inline-flex">
                                    <label for="dialogyear"
                                        class="block text-sm font-medium text-gray-700 pt-2 pr-2">Year</label>
                                    <select id="dialogyear" class="w-50 px-3 py-2 border-2 rounded-md text-sm mr-2">
                                        <option value="">Select Year</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    ...
                                    <label for="dialogset"
                                        class="block text-sm font-medium text-gray-700 pt-2 pr-2">Set</label>
                                    <select id="dialogset" class="w-50 px-3 py-2 border-2 rounded-md text-sm">
                                        <option value="">Select Set</option>
                                        <option value="A">A</option>
                                        <option value="B">B</option>
                                        <option value="C">C</option>
                                ...
                                <button type="submit"
                                    class="bg-purple-500 text-white px-4 py-2 rounded-md text-sm hover:bg-purple-600 w-full">
                ...
                <table class="min-w-full bg-white border border-gray-200 rounded-lg">
                    <thead class="bg-purple-200">
                        <tr>
                            ...
                            <th class="pr-7 py-2 text-sm font-medium text-purple-700">Action</th>
                        </tr>
                    </thead>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function renderTable() {
                ...
                <td class="px-4 py-2 text-sm text-gray-700">
                    <div class="flex space-x-2 mr-[-4rem]">
                        <button onclick="viewStudent('${student.id}')" 
                                class="text-blue-600 hover:text-blue-800 flex items-center">
                                <img src="/storage/icons/view.png" alt="paymnetmanagement"
                            style="width: 25px; height: auto;">
                        </button>
                        <button onclick="editStudent('${student.id}')" 
                                class="text-green-600 hover:text-green-800 flex items-center">
                                <img src="/storage/icons/edit.png" alt="paymnetmanagement"
                            style="width: 25px; height: auto;">
                        </button>
                        <button onclick="deleteStudent('${student.id}')" 
                                class="text-red-600 hover:text-red-800 flex items-center">
                                <img src="/storage/icons/delete.png" alt="paymnetmanagement"
                            style="width: 25px; height: auto;">
                        </button>
                    </div>
                </td>
