document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".delete-user").forEach((button) => {
        button.addEventListener("click", function () {
            ...
            document.getElementById("username_to_delete").textContent =
                userData["user_name"];
    ...
    document.querySelectorAll(".view-user").forEach((button) => {
        button.addEventListener("click", function () {
            ...
            document.getElementById("va_institute_name").textContent =
                userData["institute"]["institute_name"];
            document.getElementById("va_username").textContent =
                userData["user_name"];
            document.getElementById("va_email").textContent = userData["email"];
            document.getElementById("va_status").textContent =
                userData["status"];
    ...
    document.querySelectorAll(".edit-user").forEach((button) => {
        button.addEventListener("click", function () {
            ...
            document.getElementById("ea_institute_name").textContent =
                userData["institute"]["institute_name"];
            document.getElementById("ea_user_name").value =
                userData["user_name"];
