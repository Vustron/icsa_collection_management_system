            ...
            $institute_names[2] => [
                "programs" => [
                    ...
                    [
                        ...
                        "name" =>
                            "Bachelor of Science in Disaster Resiliency and Managemen",
                        "status" => "active",
                        "delete_flag" => 0,
                        "date_created" => now(),
                        "date_updated" => now(),
            ...
            $institute_names[3] => [
                "programs" => [
                    [
                        ...
                        "name" =>
                            "Bachelor of Secondary Education Major in English, Mathematics and Sciences",
                        "status" => "active",
                        "delete_flag" => 0,
                        "date_created" => now(),
                        "date_updated" => now(),
